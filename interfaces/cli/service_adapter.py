...
class ServiceAdapter:
    ...
    def __init__(self, bot_id: str, user_id: str, business_type: str):
        """
        初始化适配器
        ...
        # 初始化会话状态
        session_manager.update_business_type(bot_id, user_id, business_type)
        session_manager.set_sub_menu(bot_id, user_id, None)
    ...
    def _create_service(self):
        ...
        try:
            ...
            # 创建实例，传递bot_id
            return service_class(self.user_id, self.bot_id)
